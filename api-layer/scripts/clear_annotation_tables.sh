...
ANNOTATION_CLICKHOUSE_DB="${ANNOTATION_CLICKHOUSE_DB:-default}"
ANNOTATION_CLICKHOUSE_USER="${ANNOTATION_CLICKHOUSE_USER:-admin}"
ANNOTATION_CLICKHOUSE_PASS="${ANNOTATION_CLICKHOUSE_PASS:-admin}"
