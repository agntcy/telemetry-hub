...
The `telemetry-hub` maintainers take all security issues in the project
seriously. Thank you for improving the security of `AGNTCY telemetry-hub`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

The `telemetry-hub` repository leverages GitHub's private vulnerability reporting.
