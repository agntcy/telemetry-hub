...
from metrics_computation_engine.entities.models.session import AgentView, SpanEntity
...
def get_enhanced_agent_view(session: 'SessionEntity', agent_name: str) -> EnhancedAgentView:
    """
