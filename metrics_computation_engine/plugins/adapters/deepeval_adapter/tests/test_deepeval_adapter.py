...
class TestDeepEvalAdapterInitialization:
    ...
    def test_init_with_valid_metric_name(self):
        ...
        assert adapter.metric_configuration.metric_name == "ConversationCompletenessMetric"
...
class TestDeepEvalInputAssessment:
    ...
    async def test_assess_span_entity_missing_payloads(self):
        ...
        # Assert: Invalid
        assert is_valid is False
        assert "input_payload" in error or "output_payload" in error or "entity_name" in error
    
    @pytest.mark.asyncio
    async def test_assess_session_entity_valid(self):
        """Test assessment of valid SessionEntity."""
        adapter = DeepEvalMetricAdapter("ConversationCompletenessMetric")  # Session-level
    ...
    async def test_assess_session_entity_no_matching_entity_type(self):
        ...
        adapter = DeepEvalMetricAdapter("ConversationCompletenessMetric")  # Requires llm
...
class TestDeepEvalToolMetrics:
    ...
    def test_task_completion_requires_tool_calls(self):
        ...
        requirements = adapter.metric_configuration.requirements.required_input_parameters
    ...
    def test_task_completion_uses_tools_calculator(self):
        ...
        calculator_name = adapter.metric_configuration.test_case_calculator.__class__.__name__
